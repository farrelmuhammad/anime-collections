                ...
                <div className="container mx-auto py-5">
                    <div className="flex flex-stretch items-center">
                        ...
                        <div className="w-auto">
                            <ul
                                className={["fixed shadow-xl bg-white inset-0 flex flex-col items-center justify-center opacity-0 md:visible md:flex-row md:bg-transparent md:relative md:opacity-100 md:flex md:items-center", toggleMainMenu ? "opacity-100 z-30 visible" : "invisible opacity-0"].join(" ")}
                                id="menu"
                            >
