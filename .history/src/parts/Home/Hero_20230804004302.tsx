    ...
    return (
        <section className="flex items-center hero">
            <div className="w-full absolute z-20 inset-0 md:relative md:w-1/2 text-center flex flex-col justify-center hero-caption">
                ...
                <div className="flex justify-center md:justify-start mt-4"> {/* Use flex to align items */}
                    <a
                        href="#browse-the-room"
                        className="bg-red-500 text-white hover:bg-black hover:text-red-400 rounded-full px-8 py-3 mr-4 inline-block flex-none transition duration-200"
                    >
                        Watch Now
                    </a>
                    <a
                        href="#browse-the-room"
                        className="bg-red-500 text-white hover:bg-black hover:text-red-400 rounded-full px-6 py-3 inline-block flex-none transition duration-200"
                    >
                        +
                    </a>
                </div>
