    ...
    return (
        <section className="flex items-center hero">
            <div className="w-full absolute z-20 inset-0 md:relative md:w-1/2 text-center flex flex-col justify-center hero-caption">
                ...
                <div className="flex justify-center md:justify-start"> {/* Use flex to align items */}
                    <a
                        href="#browse-the-room"
                        className="bg-red-500 text-white hover:bg-black hover:text-red-400 rounded-full px-8 py-3 mt-4 mr-4 inline-block flex-none transition duration-200"
                    >
                        Watch Now
                    </a>
                    <button
                        className="bg-blue-500 text-white hover:bg-black hover:text-blue-400 rounded-full px-8 py-3 mt-4 inline-block flex-none transition duration-200"
                    >
                        Additional Button
                    </button>
                </div>
